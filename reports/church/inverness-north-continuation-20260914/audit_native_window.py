...
p=Path('/var/home/dan/nsmarks-church-20260726/sources');out=Path('/var/home/dan/nsmarks-church-20260914/inverness-north-review');window=[13450,850,2000,2200]
print('Native original window',flush=True)
a=gdal.Translate('',str(p/'inverness.jp2'),srcWin=window,format='MEM');x=a.ReadAsArray()
gdal.Translate(str(out/'IN2-lowland-native.png'),a,format='PNG')
...
(out/'native-window-comparison.json').write_text(json.dumps(r,indent=2)+'\n');print(json.dumps(r),flush=True)
