...
const path='/Users/dfakkeldy/Downloads/church-cape-breton-northern-20260915/rendered/cape-breton-tps8-review-20m.tif';
const bytes=readFileSync(path);
const sha=createHash('sha256').update(bytes).digest('hex');
assert.equal(sha,'d866dbc0dcc4171d203e10bac811062f02a5287bb9e0c2bf4f5b8f5ec80c0299');
...
assert.deepEqual(parsed.pixelSize,{width:6680,height:5353});
assert.ok(parsed.georef);
assert.equal(parsed.georef.crs,'EPSG:3857');
const expected=[-6772600,20,0,5841560,0,-20];
