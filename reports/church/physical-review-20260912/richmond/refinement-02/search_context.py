...
frames=[]
for name,x,y,w,h in [('saint-esprit',24500,12500,8000,6500),('north-fresh',12000,2800,9500,6800),('west-fresh',1000,13700,10000,9000)]:
 sw=1600;sh=round(h*sw/w);im=Image.new('RGB',(sw,sh),'white');d=ImageDraw.Draw(im);candidates=[]
