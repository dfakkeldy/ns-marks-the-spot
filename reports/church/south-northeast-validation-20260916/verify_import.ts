...
const root='reports/church/south-northeast-validation-20260916/';
...
const results=[];
for(const [file,ncontrols,nchecks] of [['controls.csv',13,0],['fresh-validation.csv',13,18],['new-checks.csv',13,2]] as const){
