...
for ident,span in [('IS52',2400),('IS53',2200)]:
 o=json.loads((R/'observations'/('IS52-corrected.json' if ident=='IS52' else ident+'.json')).read_text());lon,lat=o['lonlat'];c=math.cos(math.radians(lat));im=Image.new('RGB',(1000,1040),'white');d=ImageDraw.Draw(im);selected=[]
