...
const root='reports/church/south-eastern-coverage-validation-20260916/';
...
const results=[];
for(const [file,ncontrols,nchecks] of [['controls.csv',13,0],['fresh-validation.csv',13,19],['new-checks.csv',13,1],['corrected-validation.csv',13,20],['corrected-check.csv',13,1]] as const){
