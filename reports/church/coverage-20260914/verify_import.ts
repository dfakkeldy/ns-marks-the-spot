...
const root = 'reports/church/coverage-20260914/richmond/';
const files = [
  ['additional-validation-review.csv', 14, 2, 'tps'],
  ['affine14-controls.csv', 14, 0, 'affine'],
  ['affine14-diagnostic-review.csv', 14, 28, 'affine'],
  ['affine14-fresh-validation.csv', 14, 6, 'affine'],
] as const;
const results = [];
