...
const path='/Users/dfakkeldy/Downloads/church-cape-breton-interior-20260915/tps6-rendered/cape-breton-tps6-review-20m.tif';
const bytes=readFileSync(path);
const sha=createHash('sha256').update(bytes).digest('hex');
assert.equal(sha,'9ece5d16898647390987aa7614cb93367943947b6d62bceeafc95b34d0aaf072');
...
assert.deepEqual(parsed.pixelSize,{width:6655,height:5344});
assert.ok(parsed.georef);
assert.equal(parsed.georef.crs,'EPSG:3857');
const expected=[-6772540,20,0,5841360,0,-20];
