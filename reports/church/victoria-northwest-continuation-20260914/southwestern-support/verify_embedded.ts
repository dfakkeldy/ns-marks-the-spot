...
const path='/Users/dfakkeldy/Downloads/church-victoria-nw-continuation-20260914/tps15-rendered/victoria-northwest-tps15-review-20m.tif';
const bytes=readFileSync(path);
const sha=createHash('sha256').update(bytes).digest('hex');
assert.equal(sha,'aec83eeca7f49a82c88009d01ccda482e59130f3808eede04b5825480ccf3e82');
...
assert.deepEqual(parsed.pixelSize,{width:2435,height:3906});
assert.ok(parsed.georef);
assert.equal(parsed.georef.crs,'EPSG:3857');
const expected=[-6759140,20,0,5956500,0,-20];
