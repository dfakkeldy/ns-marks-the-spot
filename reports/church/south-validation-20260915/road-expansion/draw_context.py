...
for layer,name in [(8,'roads'),(7,'highways'),(5,'bridges'),(6,'railways')]:
 for f in json.loads((C/(name+'.geojson')).read_text())['features']:
  if f['geometry']['type']=='LineString':features.append((layer,f))
water={}
for p in ['/Users/dfakkeldy/Downloads/church-georeferencing-20260912/reference/water-lines.geojson','/Users/dfakkeldy/Downloads/church-review-20260913/south-west-water-lines.geojson','/Users/dfakkeldy/Downloads/church-south-validation-20260915/southwest-water-lines.geojson']:
