...
const root='reports/church/cape-breton-eastern-20260915/';
const results=[];
for(const [file,ncontrols,checks] of [['controls.csv',11,0],['new-checks.csv',11,2],['cumulative-fresh.csv',11,8]] as const){
