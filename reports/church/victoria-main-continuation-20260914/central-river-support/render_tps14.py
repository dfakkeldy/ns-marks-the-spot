...
def main():
 ...
 cut=a.out/'victoria-main-tps14-cutline.geojson';cut.write_text(cutline_geojson(transform(densify(poly,250)).tolist(),3857));vrt=a.out/'victoria-main-tps14.vrt'
 ...
 raster=a.out/'victoria-main-tps14-review-20m.tif'
