...
const path='/Users/dfakkeldy/Downloads/church-cape-breton-regional-20260915/rendered/cape-breton-tps11-review-20m.tif';
const bytes=readFileSync(path);
const sha=createHash('sha256').update(bytes).digest('hex');
assert.equal(sha,'4ee6ced679c11474ff54bf8e65f428ccb9f9a0bf8d8b15b689b238e3532e1d36');
...
assert.deepEqual(parsed.pixelSize,{width:6716,height:5374});
assert.ok(parsed.georef);
assert.equal(parsed.georef.crs,'EPSG:3857');
const expected=[-6773320,20,0,5841900,0,-20];
