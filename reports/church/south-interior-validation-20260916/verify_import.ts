...
const root='reports/church/south-interior-validation-20260916/';
...
const results=[];
for(const [file,ncontrols,nchecks] of [['controls.csv',13,0],['fresh-validation.csv',13,8],['new-check.csv',13,1]] as const){
