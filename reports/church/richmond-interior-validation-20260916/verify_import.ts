...
const root='reports/church/richmond-interior-validation-20260916/';
...
const results=[];
for(const [file,nchecks] of [['controls.csv',0],['new-check.csv',1],['fresh-validation.csv',17]] as const){
