...
const root='reports/church/south-western-coast-validation-20260916/';
...
const results=[];
for(const [file,ncontrols,nchecks] of [['controls.csv',13,0],['fresh-validation.csv',13,16],['new-checks.csv',13,2]] as const){
