...
points=[json.loads((R/f'observations/IS{i}.json').read_text()) for i in [47]]
features=[];refs=[]
...
water={}
for p in [Path('/Users/dfakkeldy/Downloads/church-south-validation-20260915/southwest-water-lines.geojson'),Path('/Users/dfakkeldy/Downloads/church-georeferencing-20260912/reference/water-lines.geojson'),Path('/Users/dfakkeldy/Downloads/church-review-20260913/south-west-water-lines.geojson'),Path('/Users/dfakkeldy/Downloads/church-south-eastern-validation-20260915/interior-water.geojson'),Path('/Users/dfakkeldy/Downloads/church-south-extension-validation-20260916/extension-water-lines.geojson')]:
 refs.append(p)
