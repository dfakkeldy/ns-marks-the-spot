...
files=[(Path('/Users/dfakkeldy/Downloads/church-georeferencing-20260912/reference/water-lines.geojson'),4,'#0077aa'),(Path('/Users/dfakkeldy/Downloads/church-south-road-validation-20260915/roads.geojson'),8,'#bb9955'),(Path('/Users/dfakkeldy/Downloads/church-south-road-validation-20260915/highways.geojson'),7,'#444444')];selected=[]
...
d.line((685,700,715,700),fill='red',width=2);d.line((700,685,700,715),fill='red',width=2);d.text((10,1410),'Unscored reference search around source McIntyre Lake guide; 5000 ground metres; north up.',fill='black',font=font);im.save(r/'mcintyre-reference-search.jpg',quality=95);(r/'mcintyre-reference-context.json').write_text(json.dumps(selected));(r/'mcintyre-search-guide.json').write_text(json.dumps({'pixel_xy':[22100,31360],'predicted_lonlat':ll,'role':'search only, not an observation'},indent=2));print(ll)
