...
r=Path('/Users/dfakkeldy/Downloads/church-south-extension-validation-20260916');rows=json.loads((r/'all-junction-search.json').read_text());water=Path('/Users/dfakkeldy/Downloads/church-south-extension-validation-20260916/extension-water-lines.geojson');roads=Path('/Users/dfakkeldy/Downloads/church-south-road-validation-20260915');font=ImageFont.truetype('/System/Library/Fonts/Helvetica.ttc',13)
for name,index in [('north-little',3)]:
