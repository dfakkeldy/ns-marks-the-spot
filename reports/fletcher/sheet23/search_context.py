...
ROOT=Path('/Users/dfakkeldy/Downloads/fletcher-sheet23/search')
ROOT.mkdir(parents=True,exist_ok=True)
DATA=Path('/Users/dfakkeldy/Downloads/fletcher-sheet23/reference-full')
REPO=Path('/Users/dfakkeldy/.codex/worktrees/0ca7/ns-marks-the-spot')
d=json.loads((REPO/'reports/fletcher/sheet23/search-guide.json').read_text())
...
im=Image.open('/Users/dfakkeldy/Downloads/fletcher-sheet23/native/sheet23.png');c=im.crop(box);c.save(ROOT/(name+'-source.png'));d=ImageDraw.Draw(c)
