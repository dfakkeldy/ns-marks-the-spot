...
ROOT=Path('/Users/dfakkeldy/Downloads/fletcher-sheet13/search')
ROOT.mkdir(parents=True,exist_ok=True)
DATA=Path('/Users/dfakkeldy/Downloads/fletcher-sheet13/reference-full')
REPO=Path('/Users/dfakkeldy/.codex/worktrees/0ca7/ns-marks-the-spot')
d=json.loads((REPO/'tools/fletcher/observations/sheet-13.json').read_text())
...
im=Image.open('/Users/dfakkeldy/Downloads/fletcher-sheet13/native/sheet13.png');c=im.crop(box);c.save(ROOT/(name+'-source.png'));d=ImageDraw.Draw(c)
