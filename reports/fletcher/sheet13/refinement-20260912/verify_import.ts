...
const directory = process.argv[2] ?? 'reports/fletcher/sheet13/refinement-20260912/';
...
const validation = parseFletcherGcps(readFileSync(directory + 'sheet-13-validation-review.csv', 'utf8'), options);
...
const scores = [...JSON.parse(readFileSync(directory + 'final-raster-receipt.json', 'utf8')).points,
