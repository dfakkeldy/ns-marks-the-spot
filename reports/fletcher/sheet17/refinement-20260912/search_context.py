...
ROOT=Path('/Users/dfakkeldy/Downloads/fletcher-sheet17/refinement-20260912/search')
ROOT.mkdir(parents=True,exist_ok=True)
DATA=Path('/Users/dfakkeldy/Downloads/fletcher-sheet17/reference-full')
REPO=Path.cwd()
d=json.loads((REPO/'tools/fletcher/observations/sheet-17.json').read_text())
# This sheet has axis observations only, not measured slanted intersections. Approximate search ONLY.
...
im=Image.open('/Users/dfakkeldy/Downloads/fletcher-sheet17/native/sheet17.png');c=im.crop(box);c.save(ROOT/(name+'-source.png'));d=ImageDraw.Draw(c)
