...
RASTER = DATA / "regional-ten/sheet-17-full-sheet.tif"
NEIGHBORS = {"18": ("Sheet 18: provisional 14 controls", Path.home() / "Downloads/fletcher-sheet18/regional-fourteen/sheet-18-full-sheet.tif")}
REGIONS = {'18-western-lake-north': [-60.858,45.885,-60.827,45.925], '18-western-lake-south': [-60.858,45.754,-60.827,45.802]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 17: provisional 10 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
