...
NEIGHBORS = {"08": ("Sheet 8: provisional 10-control TPS", Path.home() / "Downloads/fletcher-sheet08/regional-ten/sheet-08-full-sheet.tif")}
REGIONS = {'08-west-north': [-60.495, 46.56, -60.445, 46.62], '08-west-middle': [-60.495, 46.5, -60.445, 46.56], '08-west-south': [-60.495, 46.445, -60.445, 46.5]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 07: provisional 11 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
