...
RASTERS = [
    ("Prior 11 controls + modern reference", DATA / "regional-eleven/sheet-07-full-sheet.tif"),
    ("Experimental 12 controls + modern reference", RASTER),
]
REGIONS = {'northern-interior': [-60.45, 46.595, -60.355, 46.635], 'pathend-morrison': [-60.445, 46.56, -60.365, 46.598], 'mcleod-ferry': [-60.485, 46.54, -60.385, 46.573], 'mill-wreck-cove': [-60.49, 46.5, -60.41, 46.54], 'north-shore-french': [-60.49, 46.47, -60.42, 46.51], 'breeding-cove': [-60.485, 46.445, -60.43, 46.475], 'full-sheet': [-60.5, 46.43, -60.02, 46.65]}
