"""Inspect the actual provisional Sheet07 raster, alone and overlaid with NSTDB geometry.
...
DATA = Path.home() / "Downloads/fletcher-sheet07"
OUT = HERE / "adjacent-sheet-review"
OUT.mkdir(exist_ok=True)
RASTER = DATA / "refinement-20260912/sheet-07-full-sheet.tif"
NEIGHBORS = {"04": ("Sheet 04: provisional eight controls", Path.home()/"Downloads/fletcher-sheet04/regional-eight/sheet-04-full-sheet.tif"), "08": ("Sheet 08: provisional eleven controls", Path.home()/"Downloads/fletcher-sheet08/refinement-20260912/sheet-08-full-sheet.tif")}
REGIONS = {"04-north-coast": [-60.415,46.61,-60.345,46.65], "04-north-interior": [-60.49,46.61,-60.41,46.65], "08-west-north": [-60.495,46.56,-60.445,46.62], "08-west-middle": [-60.495,46.5,-60.445,46.56], "08-west-south": [-60.495,46.445,-60.445,46.5]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 07: experimental 12 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
    ...
    frames.append(
        {
            ...
            "reference": "reports/fletcher/sheet07/reference-receipts.json",
