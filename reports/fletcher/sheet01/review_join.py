"""Inspect the actual provisional Sheet01 raster, alone and overlaid with NSTDB geometry.
...
RASTER = DATA / "regional-eight/sheet-01-full-sheet.tif"
NEIGHBORS = {"03": ("Sheet 3: provisional 7-control TPS", Path.home()/"Downloads/fletcher-sheet03/regional-seven/sheet-03-full-sheet.tif"),"02": ("Sheet 2: provisional 9-control TPS", Path.home()/"Downloads/fletcher-sheet02/regional-nine/sheet-02-full-sheet.tif")}
REGIONS = {'03-south-west': [-60.73, 46.935, -60.57, 46.99], '03-south-east': [-60.585, 46.935, -60.425, 46.99], '02-southeast-coast': [-60.49, 46.935, -60.355, 46.99]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 01: provisional 8 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
    ...
    frames.append(
        {
            ...
            "reference": "reports/fletcher/sheet01/reference-receipts.json",
