...
import sys
R=Path.cwd(); D=R/'reports/fletcher/sheet01'; L=Path.home()/'Downloads/fletcher-sheet01'
...
exec(compile(src,str(p),'exec'),ns);ns['PACKETS']=[('01','sheet01/'+sys.argv[1],str(L/'native/sheet01.png'),str(L/'reference-full'),sys.argv[5:])];ns['main']()
