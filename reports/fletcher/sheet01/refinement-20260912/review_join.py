...
RASTER = DATA / "refinement-20260912/sheet-01-full-sheet.tif"
NEIGHBORS = {"03": ("Sheet 3: experimental 10-control TPS", Path.home()/"Downloads/fletcher-sheet03/refinement-20260912/result-ten/sheet-03-full-sheet.tif"),"02": ("Sheet 2: experimental 10-control TPS", Path.home()/"Downloads/fletcher-sheet02/refinement-20260912/sheet-02-full-sheet.tif")}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 01: experimental 10 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
