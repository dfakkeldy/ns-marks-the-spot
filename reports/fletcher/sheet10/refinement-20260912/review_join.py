"""Inspect the actual provisional Sheet10 raster, alone and overlaid with NSTDB geometry.
...
DATA = Path.home() / "Downloads/fletcher-sheet10"
OUT = HERE / "adjacent-sheet-review"
OUT.mkdir(exist_ok=True)
RASTER = DATA / "refinement-20260912/sheet-10-full-sheet.tif"
NEIGHBORS = {"08": ("Sheet 08: provisional 10-control TPS", Path.home()/"Downloads/fletcher-sheet08/regional-ten/sheet-08-full-sheet.tif"), "11": ("Sheet 11: provisional 26-control TPS", Path.home() / "Downloads/fletcher-sheet11/completion-20260911/sheet-11-exact.tif"), "12": ("Sheet 12: provisional 17-control TPS", Path.home() / "Downloads/fletcher-sheet12/refinement-20260912/17-control/sheet-12-full-sheet.tif")}
REGIONS = {"08-north-west": [-60.84,46.437,-60.70,46.46], "08-north-east": [-60.60,46.437,-60.46,46.46], "11-west-north": [-60.875,46.37,-60.83,46.445], "11-west-south": [-60.875,46.28,-60.83,46.35], "12-south-west": [-60.84,46.255,-60.68,46.28], "12-south-east": [-60.66,46.255,-60.48,46.28]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 10: provisional 13 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
    ...
    frames.append(
        {
            ...
            "reference": "reports/fletcher/sheet10/reference-receipts.json",
