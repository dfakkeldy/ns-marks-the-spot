...
const directory = process.argv[2] ?? 'reports/fletcher/sheet10/refinement-20260912/';
...
const options = { pixelSize: { width: 10782, height: 7612 } };
const controls = parseFletcherGcps(readFileSync(directory + 'sheet-10-controls.csv', 'utf8'), options);
const checks = parseFletcherGcps(readFileSync(directory + 'sheet-10-diagnostic-review.csv', 'utf8'), options);
const validation = parseFletcherGcps(readFileSync(directory + 'sheet-10-validation-review.csv', 'utf8'), options);
