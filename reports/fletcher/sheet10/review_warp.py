...
RASTERS = [
    ("12-control provisional TPS raster", RASTER),
    ("Same raster + modern reference", RASTER),
]
REGIONS = {'upper-middle': [-60.86, 46.39, -60.7, 46.45], 'lower-middle': [-60.8, 46.33, -60.68, 46.4], 'west-branch': [-60.86, 46.31, -60.68, 46.37], 'upper-barasois': [-60.7, 46.4, -60.6, 46.45], 'barasois-mckay': [-60.66, 46.35, -60.56, 46.41], 'bentinck-extension': [-60.54, 46.39, -60.45, 46.45], 'indian-mcaskill': [-60.58, 46.35, -60.46, 46.42], 'baddeck-lakes': [-60.83, 46.27, -60.68, 46.33], 'north-river': [-60.67, 46.27, -60.58, 46.36], 'st-anns-beacon': [-60.6, 46.27, -60.47, 46.35], 'full-sheet': [-60.89, 46.25, -60.42, 46.47]}
