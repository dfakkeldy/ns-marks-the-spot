...
RASTERS = [
    ("Prior 10 controls + modern reference", DATA / "refinement-20260912/sheet-04-full-sheet.tif"),
    ("Experimental 11 controls + modern reference", RASTER),
]
REGIONS = {'black-pine':[-60.49,46.745,-60.35,46.795],'black-cove-mary':[-60.395,46.73,-60.31,46.785],'warren-interior':[-60.49,46.69,-60.345,46.74],'ingonish-island':[-60.395,46.665,-60.315,46.72],'clyburn-middle':[-60.49,46.645,-60.315,46.675],'freshwater-harbour':[-60.45,46.61,-60.33,46.655],'smoky-cape':[-60.39,46.60,-60.315,46.65],'full-sheet':[-60.51,46.59,-60.015,46.84]}
