...
const directory = process.argv[2] ?? 'reports/fletcher/sheet04/refinement-20260912/';
...
const options = { pixelSize: { width: 10629, height: 7603 } };
const controls = parseFletcherGcps(readFileSync(directory + 'sheet-04-controls.csv', 'utf8'), options);
const checks = parseFletcherGcps(readFileSync(directory + 'sheet-04-diagnostic-review.csv', 'utf8'), options);
const validation = parseFletcherGcps(readFileSync(directory + 'sheet-04-validation-review.csv', 'utf8'), options);
