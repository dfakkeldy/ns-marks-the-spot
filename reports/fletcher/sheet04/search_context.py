...
ROOT=Path('/Users/dfakkeldy/Downloads/fletcher-sheet04/search')
ROOT.mkdir(parents=True,exist_ok=True)
DATA=Path('/Users/dfakkeldy/Downloads/fletcher-sheet04/reference-full')
REPO=Path('/Users/dfakkeldy/.codex/worktrees/0ca7/ns-marks-the-spot')
d=json.loads((REPO/'reports/fletcher/sheet04/search-guide.json').read_text())
known=[{'pixel_xy':[a['pixel_x'],b['pixel_y']], 'lonlat':[a['lon'],b['lat']]} for a in d['meridians'] for b in d['parallels']]
...
im=Image.open('/Users/dfakkeldy/Downloads/fletcher-sheet04/native/sheet04.png');c=im.crop(box);c.save(ROOT/(name+'-source.png'));d=ImageDraw.Draw(c)
