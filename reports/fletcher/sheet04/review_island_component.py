...
(D/'island-component-review.json').write_text(json.dumps(dict(start_objectid=17782,coast_objectids=sorted(seen),northern_extremity=r,scope='Connected source coast component within reference query, used to verify northern tip; not whole-island completeness beyond query.'),indent=2)+'\n')
