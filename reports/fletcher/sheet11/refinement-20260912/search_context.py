...
ROOT=Path('/Users/dfakkeldy/Downloads/fletcher-sheet11/refinement-20260912/search')
ROOT.mkdir(parents=True,exist_ok=True)
DATA=Path('/Users/dfakkeldy/Downloads/fletcher-sheet11/reference-full')
REPO=Path.cwd()
d=json.loads((REPO/'tools/fletcher/observations/sheet-11.json').read_text())
...
im=Image.open('/Users/dfakkeldy/Downloads/fletcher-sheet11/native/sheet11.png');c=im.crop(box);c.save(ROOT/(name+'-source.png'));d=ImageDraw.Draw(c)
