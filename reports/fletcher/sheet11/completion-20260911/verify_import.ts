...
const directory = process.argv[2] ?? 'reports/fletcher/sheet11/completion-20260911/';
const expectedControls = JSON.parse(readFileSync(directory + 'western-fit.json', 'utf8')).points.length;
const expectedChecks = JSON.parse(readFileSync(directory + 'western-diagnostics.json', 'utf8')).points.length;
...
const scores = JSON.parse(readFileSync(directory + 'western-diagnostic-scores.json', 'utf8'));
