...
OUT = HERE / "sheet14-feature-join"
OUT.mkdir(exist_ok=True)
RASTER = DATA / "completion-20260911/sheet-11-exact.tif"
RASTERS = [
    ("Sheet 11: 26-control provisional raster", RASTER),
    ("Sheet 14: 26-control Hay revision", Path.home() / "Downloads/fletcher-sheet14/hay-boundary-audit/hay-result/sheet-14-full-sheet.tif"),
]
REGIONS = {'coast': [-61.281, 46.26, -61.258, 46.288], 'western-interior': [-61.255, 46.265, -61.222, 46.288]}
