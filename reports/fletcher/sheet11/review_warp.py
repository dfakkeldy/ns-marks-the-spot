...
RASTER = DATA / "trial/sheet-11-provisional.tif"
RASTERS = [
    ("Provisional TPS raster", RASTER),
...
REGIONS = {
    ...
    "gallant-north-unresolved": [-61.065, 46.405, -61.006, 46.450],
