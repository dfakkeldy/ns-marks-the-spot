...
DATA = Path.home() / "Downloads/fletcher-sheet08"
OUT = HERE / "adjacent-sheet-review"
OUT.mkdir(exist_ok=True)
RASTER = DATA / "refinement-20260912/sheet-08-full-sheet.tif"
NEIGHBORS = {"09": ("Sheet 9: provisional 24-control TPS", Path.home() / "Downloads/fletcher-sheet09/completion-20260911/sheet-09-full-sheet.tif"), "10": ("Sheet 10: provisional 12-control TPS", Path.home() / "Downloads/fletcher-sheet10/regional-twelve/sheet-10-full-sheet.tif")}
REGIONS = {"09-west-north": [-60.90,46.54,-60.82,46.62], "09-west-south": [-60.90,46.45,-60.82,46.53], "10-south-west": [-60.85,46.425,-60.67,46.46], "10-south-east": [-60.66,46.425,-60.48,46.46]}

NEIGHBORS.update({"05": ("Sheet 05: provisional 11 controls", Path.home()/"Downloads/fletcher-sheet05/regional-eleven/sheet-05-full-sheet.tif"), "07": ("Sheet 07: provisional 11 controls", Path.home()/"Downloads/fletcher-sheet07/regional-eleven/sheet-07-full-sheet.tif")})
REGIONS.update({"05-north-west": [-60.85,46.60,-60.68,46.635], "05-north-east": [-60.66,46.60,-60.47,46.635], "07-east-north": [-60.485,46.54,-60.43,46.62], "07-east-south": [-60.485,46.45,-60.43,46.53]})
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 08: experimental 11 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
    ...
    frames.append(
        {
            ...
            "reference": "reports/fletcher/sheet08/reference-receipts.json",
