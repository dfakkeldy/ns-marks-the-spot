...
RASTER = DATA / "regional-eleven/sheet-15-full-sheet.tif"
RASTERS = [
    ("11-control provisional TPS raster", RASTER),
    ("Same raster + modern reference", RASTER),
]
REGIONS = {'northwest-lake': [-61.235, 46.04, -61.1, 46.11], 'northeast-shore': [-60.95, 46.045, -60.835, 46.105], 'southwest-blues': [-61.23, 45.92, -61.11, 45.99], 'southeast-mackinnon': [-60.98, 45.92, -60.84, 46.015], 'central-interior': [-61.095, 45.998, -60.99, 46.055], 'mcphedran': [-61.03, 46.008, -60.955, 46.052], 'channel-islands': [-61.14, 45.94, -61.0, 45.975], 'little-narrows': [-61.015, 45.98, -60.94, 46.015], 'hume-island': [-60.947,46.022,-60.913,46.053]}
