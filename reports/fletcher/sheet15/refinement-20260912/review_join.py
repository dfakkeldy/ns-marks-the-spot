...
NEIGHBORS = {
    "12": ("Sheet 12: experimental 17 controls, corner only", Path.home()/"Downloads/fletcher-sheet12/refinement-20260912/17-control/sheet-12-full-sheet.tif"),
    "17": ("Sheet 17: provisional 10 controls, corner only", Path.home()/"Downloads/fletcher-sheet17/regional-ten/sheet-17-full-sheet.tif"),
...
REGIONS = {'12-northeastern-corner':[-60.88,46.07,-60.81,46.115], '17-southeastern-corner':[-60.88,45.90,-60.81,45.945],'18-southwestern-interior':[-61.23,45.91,-61.08,45.947], '18-southeastern-channel':[-61.085,45.91,-60.86,45.947],'13-lake-ainslie': [-61.16, 46.088, -61.115, 46.11], '13-eastern-interior': [-60.935, 46.085, -60.87, 46.115], '16-northwestern-interior': [-61.242, 46.044, -61.208, 46.079], '16-southwestern-interior': [-61.24, 45.94, -61.207, 45.97]}
