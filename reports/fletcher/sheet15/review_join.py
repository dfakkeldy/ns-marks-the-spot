...
NEIGHBORS = {
    "13": ("Sheet 13: provisional 11 controls", Path.home() / "Downloads/fletcher-sheet13/regional-eleven/sheet-13-full-sheet.tif"),
...
REGIONS = {'13-lake-ainslie': [-61.16, 46.088, -61.115, 46.11], '13-eastern-interior': [-60.935, 46.085, -60.87, 46.115], '16-northwestern-interior': [-61.242, 46.044, -61.208, 46.079], '16-southwestern-interior': [-61.24, 45.94, -61.207, 45.97]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 15: provisional 11 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
