...
const directory = process.argv[2] ?? 'reports/fletcher/sheet05/';
const expectedControls = JSON.parse(readFileSync(directory + 'final-fit.json', 'utf8')).points.length;
const expectedChecks = JSON.parse(readFileSync(directory + 'reused-diagnostic.json', 'utf8')).points.length;
...
const scores = [...JSON.parse(readFileSync(directory + 'reused-diagnostic-scores.json', 'utf8')).points,
