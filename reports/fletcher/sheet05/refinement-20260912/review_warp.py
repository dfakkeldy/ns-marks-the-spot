...
RASTERS = [
    ("Prior 11 controls + modern reference", DATA / "regional-eleven/sheet-05-full-sheet.tif"),
    ("Experimental 12 controls + modern reference", RASTER),
]
REGIONS = {'fishing-mackenzie': [-60.86, 46.7, -60.72, 46.8], 'aspy-southwest': [-60.75, 46.71, -60.62, 46.8], 'black-doherty': [-60.6, 46.72, -60.45, 46.8], 'sunday-interior': [-60.7, 46.675, -60.55, 46.75], 'clyburn-curtis': [-60.67, 46.625, -60.43, 46.72], 'cheticamp-west': [-60.86, 46.605, -60.7, 46.66], 'cheticamp-flowage': [-60.73, 46.605, -60.57, 46.695], 'south-interior': [-60.62, 46.6, -60.44, 46.65], 'full-sheet': [-60.9, 46.59, -60.42, 46.83]}
