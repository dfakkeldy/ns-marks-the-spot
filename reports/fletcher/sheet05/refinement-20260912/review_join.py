"""Inspect the actual provisional Sheet05 raster, alone and overlaid with NSTDB geometry.
...
DATA = Path.home() / "Downloads/fletcher-sheet05"
OUT = HERE / "adjacent-sheet-review"
OUT.mkdir(exist_ok=True)
RASTER = DATA / "refinement-20260912/sheet-05-full-sheet.tif"
NEIGHBORS = {"03": ("Sheet 03: provisional seven controls", Path.home()/"Downloads/fletcher-sheet03/regional-seven/sheet-03-full-sheet.tif"), "04": ("Sheet 04: provisional eight controls", Path.home()/"Downloads/fletcher-sheet04/regional-eight/sheet-04-full-sheet.tif"), "06": ("Sheet 06: provisional ten controls", Path.home()/"Downloads/fletcher-sheet06/regional-ten/sheet-06-full-sheet.tif"), "08": ("Sheet 08: provisional eleven controls", Path.home()/"Downloads/fletcher-sheet08/refinement-20260912/sheet-08-full-sheet.tif")}
REGIONS = {"03-north-west": [-60.88,46.775,-60.66,46.81], "03-north-east": [-60.66,46.775,-60.44,46.81], "04-east-north": [-60.49,46.695,-60.44,46.8], "04-east-south": [-60.49,46.605,-60.44,46.695], "06-west-north": [-60.89,46.70,-60.82,46.80], "06-west-south": [-60.89,46.605,-60.82,46.70], "08-south-west": [-60.88,46.6,-60.67,46.635], "08-south-east": [-60.67,46.6,-60.44,46.635]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 05: experimental 12 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
    ...
    frames.append(
        {
            ...
            "reference": "reports/fletcher/sheet05/reference-receipts.json",
