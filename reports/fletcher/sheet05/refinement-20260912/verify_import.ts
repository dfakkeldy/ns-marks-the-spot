...
const directory = process.argv[2] ?? 'reports/fletcher/sheet05/refinement-20260912/';
...
const options = { pixelSize: { width: 10729, height: 7623 } };
const controls = parseFletcherGcps(readFileSync(directory + 'sheet-05-controls.csv', 'utf8'), options);
const checks = parseFletcherGcps(readFileSync(directory + 'sheet-05-diagnostic-review.csv', 'utf8'), options);
const validation = parseFletcherGcps(readFileSync(directory + 'sheet-05-validation-review.csv', 'utf8'), options);
