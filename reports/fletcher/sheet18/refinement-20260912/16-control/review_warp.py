...
RASTERS = [
    ("Prior 14 controls + modern reference", DATA / "regional-fourteen/sheet-18-full-sheet.tif"),
    ("Experimental 16 controls + modern reference", RASTER),
    ("Experimental raster alone", RASTER),
]
REGIONS = {'northwest-ashfield': [-61.23, 45.86, -61.1, 45.929], 'northeast-islands': [-61.075, 45.865, -60.89, 45.93], 'southwest-highlands': [-61.23, 45.747, -61.12, 45.81], 'southeast-mainland': [-60.96, 45.739, -60.84, 45.79], 'central-marble': [-61.13, 45.795, -61.025, 45.86], 'east-harbours': [-60.97, 45.824, -60.89, 45.87], 'ross-brook': [-61.185, 45.748, -61.135, 45.805], 'west-river-denys': [-61.23, 45.818, -61.095, 45.867], 'southern-islands': [-61.115, 45.755, -61.0, 45.8]}
