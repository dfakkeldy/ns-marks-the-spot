...
RASTERS = [
    ("9-control provisional TPS raster", RASTER),
    ("Same raster + modern reference", RASTER),
]
REGIONS = {'pollys-north': [-60.48, 46.93, -60.4, 47.005], 'north-pond': [-60.5, 46.87, -60.39, 46.96], 'black-head': [-60.455, 46.84, -60.36, 46.9], 'white-point': [-60.39, 46.84, -60.31, 46.91], 'egmont-trout': [-60.37, 46.795, -60.27, 46.855], 'neils-halfway': [-60.465, 46.76, -60.28, 46.83], 'full-sheet': [-60.54, 46.74, -59.99, 47.035]}
