...
ROOT=Path('/Users/dfakkeldy/Downloads/fletcher-sheet03/refinement-20260912/search')
ROOT.mkdir(parents=True,exist_ok=True)
DATA=Path('/Users/dfakkeldy/Downloads/fletcher-sheet03/reference-full')
REPO=Path('/Users/dfakkeldy/.codex/worktrees/fletcher-alignment-20260912/ns-marks-the-spot')
d=json.loads((REPO/'reports/fletcher/sheet03/search-guide.json').read_text())
known=[{'pixel_xy':[a['pixel_x'],a['pixel_y']], 'lonlat':[d['meridians'][a['meridian_index']]['lon'],d['parallels'][a['parallel_index']]['lat']]} for a in d['intersections']]
...
im=Image.open('/Users/dfakkeldy/Downloads/fletcher-sheet03/native/sheet03.png');c=im.crop(box);c.save(ROOT/(name+'-source.png'));d=ImageDraw.Draw(c)
