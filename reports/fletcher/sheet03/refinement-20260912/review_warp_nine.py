...
OUT = HERE / "warped-review-nine"
OUT.mkdir(exist_ok=True)
RASTER = DATA / "refinement-20260912/result-nine/sheet-03-full-sheet.tif"
RASTERS = [("Previous 7-control raster + NSTDB",DATA/"regional-seven/sheet-03-full-sheet.tif"),("New 9-control raster + NSTDB",RASTER),("New raster alone",RASTER)]
