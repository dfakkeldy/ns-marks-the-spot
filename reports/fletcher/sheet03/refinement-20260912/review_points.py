...
import sys
R=Path.cwd(); D=R/'reports/fletcher/sheet03'; L=Path.home()/'Downloads/fletcher-sheet03'
...
exec(compile(src,str(p),'exec'),ns);ns['PACKETS']=[('03','sheet03/'+sys.argv[1],str(L/'native/sheet03.png'),str(L/'reference-full'),sys.argv[5:])];ns['main']()
