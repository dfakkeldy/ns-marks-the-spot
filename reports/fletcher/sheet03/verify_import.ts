...
const directory = process.argv[2] ?? 'reports/fletcher/sheet03/';
...
const controls = parseFletcherGcps(readFileSync(directory + 'sheet-03-controls.csv', 'utf8'), options);
const checks = parseFletcherGcps(readFileSync(directory + 'sheet-03-diagnostic-review.csv', 'utf8'), options);
const validation = parseFletcherGcps(readFileSync(directory + 'sheet-03-validation-review.csv', 'utf8'), options);
