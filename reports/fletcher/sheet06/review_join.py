...
NEIGHBORS = {"09": ("Sheet 9: provisional 24-control TPS", Path.home() / "Downloads/fletcher-sheet09/completion-20260911/sheet-09-full-sheet.tif")}
REGIONS = {"09-south-island": [-61.08,46.595,-60.96,46.635], "09-south-interior": [-60.97,46.595,-60.83,46.635]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 06: provisional 10 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
