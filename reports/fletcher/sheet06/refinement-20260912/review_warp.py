"""Inspect the actual provisional Sheet06 raster, alone and overlaid with NSTDB geometry.
...
DATA = Path.home() / "Downloads/fletcher-sheet06"
OUT = HERE / "warped-review"
OUT.mkdir(exist_ok=True)
RASTER = DATA / "refinement-20260912/sheet-06-full-sheet.tif"
RASTERS = [
    ("Prior 10 controls + modern reference", DATA / "regional-ten/sheet-06-full-sheet.tif"),
    ("Experimental 11 controls + modern reference", RASTER),
]
REGIONS = {'north-coast': [-60.94,46.75,-60.855,46.8], 'jumping-corney': [-60.965,46.7,-60.85,46.76], 'trout-robert': [-60.99,46.64,-60.865,46.73], 'jerome-coast': [-61.0,46.655,-60.94,46.71], 'island-harbour': [-61.05,46.615,-60.97,46.665], 'cheticamp-faribault': [-60.985,46.605,-60.855,46.655], 'daphine-repair': [-60.928,46.611,-60.866,46.643], 'full-sheet': [-61.25,46.6,-60.8,46.82]}
    ...
    frames.append(
        {
            ...
            "reference": "reports/fletcher/sheet06/reference-receipts.json",
