...
const directory = process.argv[2] ?? 'reports/fletcher/sheet06/refinement-20260912/';
...
const controls = parseFletcherGcps(readFileSync(directory + 'sheet-06-controls.csv', 'utf8'), options);
const checks = parseFletcherGcps(readFileSync(directory + 'sheet-06-diagnostic-review.csv', 'utf8'), options);
const validation = parseFletcherGcps(readFileSync(directory + 'sheet-06-validation-review.csv', 'utf8'), options);
