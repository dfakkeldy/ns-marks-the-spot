...
NEIGHBORS = {"05": ("Sheet 05: provisional twelve controls", Path.home()/"Downloads/fletcher-sheet05/refinement-20260912/sheet-05-full-sheet.tif"), "09": ("Sheet 09: provisional twenty-five controls", Path.home()/"Downloads/fletcher-sheet09/refinement-20260912/sheet-09-full-sheet.tif")}
REGIONS = {"05-east-north": [-60.89,46.70,-60.82,46.80], "05-east-south": [-60.89,46.605,-60.82,46.70], "09-south-island": [-61.08,46.595,-60.96,46.635], "09-south-interior": [-60.97,46.595,-60.83,46.635]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 06: experimental 11 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
