"""Inspect the actual provisional Sheet20 raster, alone and overlaid with NSTDB geometry.
...
RASTER = DATA / "regional-fit/sheet-20-full-sheet.tif"
RASTERS = [("Preserved 12 + modern", RASTER), ("Experimental 14 + modern", DATA/"refinement-20260912/sheet-20-full-sheet.tif"), ("Experimental 14 alone", DATA/"refinement-20260912/sheet-20-full-sheet.tif")]
REGIONS = {'northwest-inlet': [-60.85, 45.694, -60.725, 45.751], 'upper-grand-river': [-60.7, 45.699, -60.58, 45.751], 'northeast-unexplored': [-60.6, 45.685, -60.46, 45.751], 'central-grand-river': [-60.69, 45.625, -60.61, 45.704], 'western-lakes': [-60.85, 45.616, -60.74, 45.674], 'southwest-island': [-60.84, 45.584, -60.75, 45.631], 'ferguson-lake': [-60.635, 45.625, -60.54, 45.671], 'saint-esprit-coast': [-60.56, 45.608, -60.465, 45.664], 'southern-extensions': [-60.755, 45.55, -60.655, 45.606]}
    ...
    frames.append(
        {
            ...
            "reference": "reports/fletcher/sheet20/reference-receipts.json",
