...
const directory = process.argv[2] ?? 'reports/fletcher/sheet20/';
const expectedControls = JSON.parse(readFileSync(directory + 'regional-fit.json', 'utf8')).points.length;
const expectedChecks = JSON.parse(readFileSync(directory + 'diagnostic-reused.json', 'utf8')).points.length;
...
const scores = [...JSON.parse(readFileSync(directory + 'regional-diagnostic-scores.json', 'utf8')).points,
