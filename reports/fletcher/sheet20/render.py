...
spec = importlib.util.spec_from_file_location('pipeline', HERE.parent / 'full-sheets/render.py')
pipeline = importlib.util.module_from_spec(spec)
spec.loader.exec_module(pipeline)
c = pipeline.c
out = Path.home() / 'Downloads/fletcher-sheet20/regional-fit'
out.mkdir(parents=True, exist_ok=True)
source = out.parent / 'native/sheet20.png'
fit_path = HERE / 'regional-fit.json'
...
for component in ['main', 'southwest-islet', 'southeast-islet']:
    path = HERE / f'boundary-{component}.json'
