...
NEIGHBORS = {"13": ("Sheet 13: provisional 11-control TPS", Path.home() / "Downloads/fletcher-sheet13/regional-eleven/sheet-13-full-sheet.tif")}
REGIONS = {"13-west-north": [-60.86,46.205,-60.822,46.269], "13-west-south": [-60.86,46.095,-60.822,46.17]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 12: provisional 14 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
