...
NEIGHBORS = {"10": ("Sheet 10: provisional 12-control TPS", Path.home() / "Downloads/fletcher-sheet10/regional-twelve/sheet-10-full-sheet.tif"), "13": ("Sheet 13: provisional 11-control TPS", Path.home() / "Downloads/fletcher-sheet13/regional-eleven/sheet-13-full-sheet.tif")}
REGIONS = {"10-north-west": [-60.84,46.25,-60.70,46.28], "10-north-east": [-60.70,46.25,-60.48,46.28], "13-west-north": [-60.86,46.205,-60.822,46.269], "13-west-south": [-60.86,46.095,-60.822,46.17]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 12: provisional 17 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
    ...
    frames.append(
        {
            ...
            "reference": "reports/fletcher/sheet12/reference-receipts.json",
