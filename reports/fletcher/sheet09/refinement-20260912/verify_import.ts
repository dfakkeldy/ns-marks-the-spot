...
const directory = process.argv[2] ?? 'reports/fletcher/sheet09/refinement-20260912/';
...
const options = { pixelSize: { width: 10762, height: 7642 } };
const controls = parseFletcherGcps(readFileSync(directory + 'sheet-09-controls.csv', 'utf8'), options);
const checks = parseFletcherGcps(readFileSync(directory + 'sheet-09-diagnostic-review.csv', 'utf8'), options);
const validation = parseFletcherGcps(readFileSync(directory + 'sheet-09-validation-review.csv', 'utf8'), options);
