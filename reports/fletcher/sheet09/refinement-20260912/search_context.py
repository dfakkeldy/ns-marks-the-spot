...
ROOT=Path('/Users/dfakkeldy/Downloads/fletcher-sheet09/refinement-20260912/search')
ROOT.mkdir(parents=True,exist_ok=True)
DATA=Path('/Users/dfakkeldy/Downloads/fletcher-sheet09/reference-full')
REPO=Path.cwd()
d=json.loads((REPO/'tools/fletcher/observations/sheet-09.json').read_text())
...
im=Image.open('/Users/dfakkeldy/Downloads/fletcher-sheet09/native/sheet09.png');c=im.crop(box);c.save(ROOT/(name+'-source.png'));d=ImageDraw.Draw(c)
