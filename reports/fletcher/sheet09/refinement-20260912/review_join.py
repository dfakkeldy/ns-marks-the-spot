"""Inspect the actual provisional Sheet09 raster, alone and overlaid with NSTDB geometry.
...
RASTER = DATA / "refinement-20260912/sheet-09-full-sheet.tif"
NEIGHBORS = {"06": ("Sheet 06: provisional ten controls", Path.home()/"Downloads/fletcher-sheet06/regional-ten/sheet-06-full-sheet.tif"), "08": ("Sheet 08: provisional eleven controls", Path.home()/"Downloads/fletcher-sheet08/refinement-20260912/sheet-08-full-sheet.tif"), "11": ("Sheet 11: provisional thirty controls", Path.home()/"Downloads/fletcher-sheet11/refinement-20260912/30-control/sheet-11-exact.tif")}
REGIONS = {"06-north-coast": [-61.08,46.60,-61.00,46.635], "06-north-interior": [-61.00,46.60,-60.85,46.635], "08-east-north": [-60.90,46.54,-60.82,46.62], "08-east-south": [-60.90,46.45,-60.82,46.53], "11-south-coast": [-61.14,46.435,-61.10,46.463], "11-south-interior": [-61.095,46.435,-60.99,46.463], "11-south-margaree": [-60.99,46.435,-60.85,46.463]}
...
for name, (west, south, east, north) in REGIONS.items():
    ...
    RASTERS = [("Sheet 09: experimental 25 controls", RASTER), NEIGHBORS[name.split("-")[0]]]
