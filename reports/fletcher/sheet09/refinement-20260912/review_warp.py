...
RASTERS = [
    ("Prior 24 controls + modern reference", DATA / "completion-20260911/sheet-09-full-sheet.tif"),
    ("Experimental 25 controls + modern reference", RASTER),
]
REGIONS = {
    "cheticamp-harbour": [
        -61.06792939352159,
...
REGIONS.update({'western-coast':[-61.13,46.445,-61.05,46.515], 'full-sheet':[-61.25,46.435,-60.82,46.635]})
