...
ROOT=Path('/Users/dfakkeldy/Downloads/fletcher-sheet24/search')
ROOT.mkdir(parents=True,exist_ok=True)
DATA=Path('/Users/dfakkeldy/Downloads/fletcher-sheet24/reference-full')
REPO=Path('/Users/dfakkeldy/.codex/worktrees/0ca7/ns-marks-the-spot')
d=json.loads((REPO/'reports/fletcher/sheet24/search-guide.json').read_text())
...
im=Image.open('/Users/dfakkeldy/Downloads/fletcher-sheet24/native/sheet24.png');c=im.crop(box);c.save(ROOT/(name+'-source.png'));d=ImageDraw.Draw(c)
