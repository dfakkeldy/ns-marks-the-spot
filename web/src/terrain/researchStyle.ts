...
export const RESEARCH_TERRAIN_TILES = 'https://s3.amazonaws.com/elevation-tiles-prod/terrarium/{z}/{x}/{y}.png';
...
export function researchTerrainStyle(basemap: BasemapStyle, modern: boolean, relief: ReliefSettings = DEFAULT_RELIEF): StyleSpecification {
  ...
  style.terrain = { source: 'research-elevation', exaggeration: relief.exaggeration };
