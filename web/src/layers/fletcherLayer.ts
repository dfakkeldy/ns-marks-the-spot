export const FLETCHER_TILE_REVISION =
  "fletcher-direct-rumsey-20260828.1";
...
export const fletcherSheets: readonly FletcherSheet[] = [
  ...
  // Sheets 16 and 19 are feature-led TPS refits in this revision; 16's tree
  // is the full sheet (the July cutline crop is gone), so all four bounds moved.
  { sheet: 16, bounds: [[45.88236073018403, -61.67724609375], [46.126556302418514, -61.160888671875]] },
  ...
  { sheet: 19, bounds: [[45.71768635790719, -61.6827392578125], [45.962606222421634, -61.160888671875]] },
