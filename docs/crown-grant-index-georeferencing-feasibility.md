...
> the Open Government Licence – Nova Scotia. A permission request to DNRR
> (`natural.sciences@novascotia.ca`) is **pending as of 2026-07-24**. Until written
...
1. **Blocked on licensing.** Await DNRR reply to `natural.sciences@novascotia.ca`. Produce no public tiles and commit no sheet imagery until then.
