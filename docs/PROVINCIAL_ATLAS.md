...
before generalizing and tiling. The union is rendered as a fill only, with no boundary
strokes or antialiased polygon outlines. Interior holes, disconnected areas and real gaps are retained.
