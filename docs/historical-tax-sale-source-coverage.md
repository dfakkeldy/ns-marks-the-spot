...
| Municipality of the District of Shelburne — February 9, 2026 tax sale by tender | [Official result page](https://www.municipalityofshelburne.ca/2026/02/11/tax-sale-results/) and [two-page result PDF](https://www.municipalityofshelburne.ca/wp-content/uploads/2026/02/Public-Tax-Sale-Results-2026.pdf) | AAN, PID, description, 11 numeric winning bids, 6 `NO BIDS` rows | The current municipal landing page no longer links the matching pre-sale notice or any advertised amount. The result cannot be reconciled against notice fields and does not satisfy the public historical model's positive advertised-amount contract, so no row is promoted. Result SHA-256: `71cbfdebc90e7758e9bfb37a4675a76bec6416f8c95d458e58a95dc4bb4836e4`. |
